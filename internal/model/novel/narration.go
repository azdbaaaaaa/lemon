...
type Narration struct {
	...
	Content   *NarrationContent `bson:"content" json:"content"`                     // 解说文案内容（结构化数据）
	Prompt    string            `bson:"prompt,omitempty" json:"prompt,omitempty"`   // 生成解说文案时使用的提示词
...
// NarrationChapterInfo 解说文案中的章节信息
// 用于描述解说文案对应的章节信息，避免与章节模块的 ChapterInfo 命名冲突
...
// NarrationCharacter 解说文案中的角色信息
// 用于描述解说文案中的角色，避免与其他模块的 Character 命名冲突
...
// NarrationScene 解说文案中的分镜信息
// 用于描述解说文案中的分镜，避免与其他模块的 Scene 命名冲突
...
// NarrationShot 解说文案中的特写信息
// 用于描述解说文案中的特写，避免与其他模块的 Shot 命名冲突
